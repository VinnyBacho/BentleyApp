...
export default class GridLayout extends Component {
    ...
    handleAthleticsPress = () => (
        console.log("athletics press")
    );

    handleBusPress = () => (
        console.log("bus press")
    );

    handleCoursePress = () => (
        console.log("course press")
    );

    handleDiningPress = () => (
        console.log("dining press")
    );

    handleDirectoryPress = () => (
        console.log("directory press")
    );
    ...
    handleEventsPress = () => (
        console.log("events press")
    );

    handleMapsPress = () => (
        console.log("maps press")
    );

    handleMaintenancePress = () => (
        console.log("maintenance press")
    );

    handleResidentPress = () => (
        console.log("res-life press")
    );

    handleResourcesPress = () => (
        console.log("resources press")
    );
